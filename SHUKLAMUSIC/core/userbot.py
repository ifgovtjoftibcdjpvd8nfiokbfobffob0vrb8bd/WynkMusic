    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("+wu5gwh2a98hlZjhl")
                await self.one.join_chat("RIYA_chat_support")
                await self.one.join_chat("BIT_networks")
                await self.one.join_chat("Up_10th_12th_study_group")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("+wu5gwh2a98hlZjhl")
                await self.three.join_chat("BIT_networks")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("+wu5gwh2a98hlZjhl")
                await self.four.join_chat("BIT_networks")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("+wu5gwh2a98hlZjhl")
                await self.five.join_chat("BIT_networks")
            except:
                pass
            assistants.append(5)
            try:
