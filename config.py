...
OWNER_ID = int(getenv("OWNER_ID", 7457111600))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ifgovtjoftibcdjpvd8nfiokbfobffob0vrb8bd/WynkMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://wynk.in")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://wynk.in")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/gr98kv.jpg"
)
PING_IMG_URL = getenv(
